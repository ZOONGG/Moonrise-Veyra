...
public class DescriptionComponent implements Component {
   ...
   public void draw() {
      ...
      Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.desc.getDesc(), (float)((this.p.category.getX() + 4) * 2), (float)((this.p.category.getY() + this.o + 4) * 2), Theme.getTextSecondaryColor().getRGB());
      GL11.glPopMatrix();
   }
